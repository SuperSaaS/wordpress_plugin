...
function supersaas_options()
{
  ...
  ?>
  <div class="wrap">
    <h2><?php _e('SuperSaaS Settings', 'supersaas'); // WPCS: XSS.EscapeOutput OK.
      ?></h2>
    ...
    <form method="post" action="options.php">
      ...
      <p>
        <label>
          <input type="checkbox" name="ss_autologin_enabled"
                 value="1" <?php echo get_option('ss_autologin_enabled') === '1' ? 'checked' : ''; // WPCS: XSS.EscapeOutput OK.
          ?> />
          If the user is logged into Wordpress, log him into your SuperSaaS account with the Wordpress user
          name
        </label>

        <br/>
        Automatically logging in the user requires your API key: <input type="text" name="ss_password"
                                                                        value="<?php echo get_option('ss_password'); // WPCS: XSS.EscapeOutput OK.
                                                                        ?>"/>
      </p>
      ...
      <p>
        ...
        <br/>
        <textarea name="ss_widget_script" rows="4" cols="80"
                  placeholder="Paste the script generated by https://supersaas.com/info/doc/integration/integration_with_widget">
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="ss_schedule"
                   ...
                   ?>"/><br/>
            <span
                class='description'><?php _e('The name of the schedule or URL to redirect to after login.', 'supersaas'); // WPCS: XSS.EscapeOutput OK.
              ?></span>
          </td>
        </tr>
        <tr valign="top">
